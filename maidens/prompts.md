...
<p class="comment-paragraph">\* Gemini한테 설정 구멍을 최대한 많이 찾아 달라고 하면서 주고 받은 대화에, 거의 모든 질문을 답할 수 있었기에 양이 크게 불어나면서 이걸 써 먹을 수 있는 데가 없을까 하다가 쓰게 된 내용이다. 그런 까닭에 프롬프트 길이도 아주 길고, 프롬프트 내용이 거의 그대로 원문에 들어간 경우도 많다. 근데 나중에 Gemini 등에게 평가를 시켜 보니 본편보다 반응이 훨씬 더 좋았다….</p>
